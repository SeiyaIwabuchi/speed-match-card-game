          ...
          <main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
              <Card variant="elevated">
                ...
                <CardBody>
                  <p className="mb-4 text-sm md:text-base">新しいゲームルームを作成して友達を招待しよう</p>
                  <Button 
                    variant="primary" 
                    fullWidth
              ...
              <Card variant="elevated">
                ...
                <CardBody>
                  <p className="mb-4 text-sm md:text-base">ルームコードを入力して既存のゲームに参加しよう</p>
                  <Button 
                    variant="secondary" 
                    fullWidth
              ...
              <Card variant="elevated">
                ...
                <CardBody>
                  <p className="mb-4 text-sm md:text-base">公開されているルームを探してゲームに参加しよう</p>
                  <Button 
                    variant="outline" 
                    fullWidth
                    onClick={() => onNavigate && onNavigate('rooms')}
            ...
            <div className="text-center">
              ...
              <details className="mb-6">
                <summary className="cursor-pointer text-primary-600 hover:text-primary-700 mb-4 inline-block">
                  ボタンサンプルを表示
                </summary>
